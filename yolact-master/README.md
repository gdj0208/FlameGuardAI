...
python eval.py --trained_model=weights/yolact_resnet101_smoke_39999_200000.pth --score_threshold=0.15 --top_k=15 --image=inputs/fire-001.jpeg

python eval.py --trained_model=weights/yolact_resnet101_smoke_86_10000.pth --score_threshold=0.5 --top_k=10 --images=inputs:outputs
...
python eval.py --trained_model=weights/yolact_resnet101_smoke_26_200000.pth --score_threshold=0.5 --top_k=10 --video_multiframe=4 --video=inputs/vid1.mp4:vid.mp4
```
...
python train.py --config=yolact_resnet101_smoke_config --resume=weights/yolact_resnet101_smoke_92_10000.pth --batch_size=4 --start_iter=0
