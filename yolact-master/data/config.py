...
SMOKE_CLASSES = ('Door opened', 'Door closed', 'Smoke', 'Fire', 'Cloud', 'Fog', 'Light', 'Sunlight', 'Fire Extinguisher', 'ShakeB', 'None')
...
smoke_dataset = dataset_base.copy({
    'name': 'SMOKE 2020',
    'train_images': './data/coco/images/integ_2',
    'train_info': './data/coco/annotations/integ_2/train.json',
    'valid_images': './data/coco/images/integ_2',
    'valid_info': './data/coco/annotations/integ_2/train.json',
...
yolact_resnet101_smoke_config = yolact_resnet101_config.copy({
    ...
    #'lr': 5e-4,
    'lr_warmup_init': 1e-6,
    'lr_warmup_until': 3000,
    'lr': 2e-4,

    'max_iter': 5000,
    'lr_steps': (3000, 3500, 4000, 4500, 5000),
